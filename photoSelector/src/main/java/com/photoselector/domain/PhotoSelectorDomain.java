...
import com.photoselector.ui.PhotoSelectorActivity.OnLocalPhotoListener;
...
public class PhotoSelectorDomain {
     ...
     * @param listener
     */
    public void getReccent(final OnLocalPhotoListener listener) {
     ...
     * 获取单个相册下的所有照片信息
     */
    public void getAlbum(final String name, final OnLocalPhotoListener listener) {
        final Handler handler = new Handler() {
            @SuppressWarnings("unchecked")
            @Override
            public void handleMessage(Message msg) {
